...
module.exports = function(grunt) {
	...
	grunt
			.initConfig({
				...
				concat : {
					...
					dist_raw : {
						dest : 'dist/betajs-richeditor-raw.js',
					...
					dist_scoped : {
						...
						src : [ 'vendors/scoped.js',
								'dist/betajs-richeditor-noscoped.js' ]
					}
				},
				preprocess : {
					options : {
					...
					dist : {
						src : 'dist/betajs-richeditor-raw.js',
						dest : 'dist/betajs-richeditor-noscoped.js'
					}
				},
				clean : {
					raw : "dist/betajs-richeditor-raw.js",
					closure : "dist/betajs-richeditor-closure.js"
				},
				uglify : {
					options : {
						banner : module.banner
					...
					dist : {
						files : {
							'dist/betajs-richeditor-noscoped.min.js' : [ 'dist/betajs-richeditor-noscoped.js' ],
				...
				jshint : {
					...
					source : [ "./src/*.js" ],
					dist : [ "./dist/betajs-richeditor-noscoped.js",
							"./dist/betajs-richeditor.js" ],
				...
				closureCompiler : {
					...
					dist : {
						src : [ "./vendors/beta.js",
								...
								"./dist/betajs-richeditor-noscoped.js" ],
						dest : "./dist/betajs-richeditor-closure.js"
					}
				},
				wget : {
					dependencies : {
	...
	grunt.registerTask('default', [ 'revision-count', 'concat:dist_raw',
			'preprocess', 'clean:raw', 'concat:dist_scoped',
			'uglify' ]);
